...
[SAPI-Game](../globals.md) / RegionTeamChooser
...
- [`GameComponent`](GameComponent.md)\<`S`, `RegionTeamChooserConfig`\<`P`\>\>
...
`S` *extends* [`GameState`](GameState.md)\<`P`, `any`\> = [`GameState`](GameState.md)\<`P`, `any`\>

## Constructors

### Constructor

> **new RegionTeamChooser**\<`P`, `S`\>(`state`, `options?`, `tag?`): `RegionTeamChooser`\<`P`, `S`\>
...
> `protected` `optional` **options**: `RegionTeamChooserConfig`\<`P`\>
