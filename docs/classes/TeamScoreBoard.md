...
- [`GameComponent`](GameComponent.md)\<[`GameState`](GameState.md)\<`P`\>, [`TeamScoreBoardOptions`](../interfaces/TeamScoreBoardOptions.md)\<`P`\>\>
...
> **new TeamScoreBoard**\<`P`\>(`state`, `options?`, `tag?`): `TeamScoreBoard`\<`P`\>
...
[`TeamScoreBoardOptions`](../interfaces/TeamScoreBoardOptions.md)\<`P`\>
...
> `protected` `optional` **options**: [`TeamScoreBoardOptions`](../interfaces/TeamScoreBoardOptions.md)\<`P`\>
