...
- [`GameComponent`](GameComponent.md)\<[`GameState`](GameState.md), [`EntityInteractionBlockerOptions`](../interfaces/EntityInteractionBlockerOptions.md)\>

## Constructors

### Constructor

> **new EntityInteractionBlocker**(`state`, `options?`, `tag?`): `EntityInteractionBlocker`
...
> `protected` `optional` **options**: [`EntityInteractionBlockerOptions`](../interfaces/EntityInteractionBlockerOptions.md)
