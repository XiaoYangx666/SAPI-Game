...
- [`GameComponent`](GameComponent.md)\<[`GameState`](GameState.md), [`RegionTeamCleanUpOptions`](../interfaces/RegionTeamCleanUpOptions.md)\>

## Constructors

### Constructor

> **new RegionTeamCleaner**(`state`, `options?`, `tag?`): `RegionTeamCleaner`
...
> `protected` `optional` **options**: [`RegionTeamCleanUpOptions`](../interfaces/RegionTeamCleanUpOptions.md)
