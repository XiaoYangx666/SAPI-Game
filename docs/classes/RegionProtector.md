...
- [`GameComponent`](GameComponent.md)\<[`GameState`](GameState.md), [`RegionProtectionOptions`](../interfaces/RegionProtectionOptions.md)\>

## Constructors

### Constructor

> **new RegionProtector**(`state`, `options?`, `tag?`): `RegionProtector`
...
> `protected` `optional` **options**: [`RegionProtectionOptions`](../interfaces/RegionProtectionOptions.md)
