...
- [`GameComponent`](GameComponent.md)\<[`GameState`](GameState.md), [`InteractionBlockerOptions`](../interfaces/InteractionBlockerOptions.md)\>

## Constructors

### Constructor

> **new BlockInteractionBlocker**(`state`, `options?`, `tag?`): `BlockInteractionBlocker`
...
> `protected` `optional` **options**: [`InteractionBlockerOptions`](../interfaces/InteractionBlockerOptions.md)
