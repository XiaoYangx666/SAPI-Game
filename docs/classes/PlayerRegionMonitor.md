...
- [`GameComponent`](GameComponent.md)\<[`GameState`](GameState.md), [`PlayerRegionMonitorOptions`](../interfaces/PlayerRegionMonitorOptions.md)\<`P`\>\>

## Type Parameters

### P

`P` *extends* [`GamePlayer`](GamePlayer.md)

## Constructors

### Constructor

> **new PlayerRegionMonitor**\<`P`\>(`state`, `options?`, `tag?`): `PlayerRegionMonitor`\<`P`\>
...
[`PlayerRegionMonitorOptions`](../interfaces/PlayerRegionMonitorOptions.md)\<`P`\>
...
> `protected` `optional` **options**: [`PlayerRegionMonitorOptions`](../interfaces/PlayerRegionMonitorOptions.md)\<`P`\>
