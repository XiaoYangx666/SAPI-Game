// Imported from the trace entry rather than the package root on purpose: this
// is both where the codec lives and the module-level side effect that installs
// the runtime trace implementation into @begame/core. Using the values (rather
// than a bare `import "@begame/core/trace"`) keeps the import alive through
// bundling, since @begame/test declares itself side-effect free.
import {
    decodeBegTrace,
    encodeBegTrace,
